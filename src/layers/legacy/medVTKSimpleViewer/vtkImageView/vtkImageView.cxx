...
{
    if (color   == NULL && this->GetColorTransferFunction()   == NULL &&
        opacity == NULL && this->GetOpacityTransferFunction() == NULL &&
        this->GetLookupTable() != NULL)
    {
    ...
    if (rgb != NULL)
    {
        this->StoreColorTransferFunction(rgb);
        rgb->Delete();
    }
    ...
    else if ( this->GetOpacityTransferFunction() == NULL )
        alpha = this->GetDefaultOpacityTransferFunction();

    if ( alpha != NULL )
    {
        this->StoreOpacityTransferFunction(alpha);
        alpha->Delete();
    }
    ...
    this->ApplyColorTransferFunction(this->GetColorTransferFunction());
    this->ScalarBar->SetLookupTable(this->GetColorTransferFunction());
}
