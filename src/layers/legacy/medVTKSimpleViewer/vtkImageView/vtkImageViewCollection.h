...
*/
class MEDVTKSIMPLEVIEWER_EXPORT vtkImageViewCollection : public vtkCollection
{
...
public:
    ...
    vtkSyncSet2DMacro (ShowDistanceWidget, int);
...
//BTX
class MEDVTKSIMPLEVIEWER_EXPORT vtkImageViewCollectionCommand : public vtkCommand
{
