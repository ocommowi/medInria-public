...
class MEDVTKSIMPLEVIEWER_EXPORT vtkImageView2D : public vtkImageView
{
public:
    ...
    /* virtual void SetInput (vtkImageData *image, vtkMatrix4x4 *matrix = 0); */
  ...
  */
    ...
    virtual int  GetInterpolate (void);
  ...
  */
    ...
    /**
     Set/Get the angle widget visibility.
  */
