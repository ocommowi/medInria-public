...
class medVTKSimpleViewItkDataImageNavigatorPrivate
{
public:
...
medVTKSimpleViewItkDataImageNavigator::medVTKSimpleViewItkDataImageNavigator(medAbstractView* parent):
    medAbstractNavigator(parent), d(new medVTKSimpleViewItkDataImageNavigatorPrivate)
{
...
medVTKSimpleViewItkDataImageNavigator::~medVTKSimpleViewItkDataImageNavigator()
{
    delete d;
}

QString  medVTKSimpleViewItkDataImageNavigator::identifier() const
{
    return medVTKSimpleViewItkDataImageNavigator::s_identifier();
}

QString  medVTKSimpleViewItkDataImageNavigator::s_identifier()
{
    return "medVTKSimpleViewItkDataImageNavigator";
}

bool medVTKSimpleViewItkDataImageNavigator::registered()
{
    medViewFactory * factory = medViewFactory::instance();
    return factory->registerAdditionalNavigator<medVTKSimpleViewItkDataImageNavigator>(medVTKSimpleViewItkDataImageNavigator::s_identifier(),
                                                           QStringList() << "medVtkView");
}

QStringList medVTKSimpleViewItkDataImageNavigator::handled(void) const
{
    return QStringList() << "medVtkView";
}

QString medVTKSimpleViewItkDataImageNavigator::description() const
{
    return "Navigator to interact with itk images in a medVtkView";
}

QList<medAbstractParameterL*> medVTKSimpleViewItkDataImageNavigator::linkableParameters()
{
    return d->parameters;
}

QList<medBoolParameterL*> medVTKSimpleViewItkDataImageNavigator::mouseInteractionParameters()
{
    // no parameters related to mouse interactions
    return QList<medBoolParameterL*>();
}

void medVTKSimpleViewItkDataImageNavigator::updateWidgets()
{
...
void medVTKSimpleViewItkDataImageNavigator::setMode3D(QString mode)
{
    if ( mode == "VR" )
    {
...
void medVTKSimpleViewItkDataImageNavigator::setRenderer(QString renderer)
{
    if ( renderer=="GPU" )
...
void medVTKSimpleViewItkDataImageNavigator::enableCropping(bool enabled)
{
    if ( enabled )
    {
...
QWidget *  medVTKSimpleViewItkDataImageNavigator::buildToolBoxWidget()
{
...
QWidget *medVTKSimpleViewItkDataImageNavigator::buildToolBarWidget()
{
