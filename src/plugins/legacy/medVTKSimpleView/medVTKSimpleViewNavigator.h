...
class MEDVTKSIMPLEVIEWPLUGIN_EXPORT medVTKSimpleViewNavigator : public medAbstractImageViewNavigator
{
    Q_OBJECT

public:
    medVTKSimpleViewNavigator(medAbstractView* parent);
    virtual ~medVTKSimpleViewNavigator();
...
private:
    medVTKSimpleViewNavigatorPrivate *d;
};
