...
class medVTKSimpleViewNavigatorPrivate
{
    public:
...
medVTKSimpleViewNavigator::medVTKSimpleViewNavigator(medAbstractView *parent) :
    medAbstractImageViewNavigator(parent), d(new medVTKSimpleViewNavigatorPrivate)
{
    d->parent = dynamic_cast<medAbstractImageView*>(parent);

    medVTKSimpleViewBackend* backend = static_cast<medVTKSimpleViewBackend*>(d->parent->backend());
...
medVTKSimpleViewNavigator::~medVTKSimpleViewNavigator()
{
    delete d;
}

QString  medVTKSimpleViewNavigator::identifier() const
{
    return medVTKSimpleViewNavigator::s_identifier();
}

bool medVTKSimpleViewNavigator::registered()
{
    medViewFactory * factory = medViewFactory::instance();
    return factory->registerNavigator<medVTKSimpleViewNavigator>(medVTKSimpleViewNavigator::s_identifier(),
                                                           QStringList() << "medVTKSimpleView");
}

QString  medVTKSimpleViewNavigator::s_identifier()
{
    return "medVTKSimpleViewNavigator";
}

QStringList medVTKSimpleViewNavigator::handled(void) const
{
    return QStringList() << "medVTKSimpleView";
}


QString medVTKSimpleViewNavigator::description() const
{
    return "Navigator to interact with a medVTKSimpleView";
}

QList<medAbstractParameterL*> medVTKSimpleViewNavigator::linkableParameters()
{
    return d->parameters;
}

QList<medBoolParameterL*> medVTKSimpleViewNavigator::mouseInteractionParameters()
{
...
medImageView::Orientation medVTKSimpleViewNavigator::orientation() const
{
    return d->orientation;
}

void medVTKSimpleViewNavigator::setOrientation(medImageView::Orientation orientation)
{
...
void medVTKSimpleViewNavigator::setCamera(const QVector3D &position,
...
void medVTKSimpleViewNavigator::setZoom(double zoom)
{
...
void medVTKSimpleViewNavigator::setPan(const QVector2D &pan)
{
...
void medVTKSimpleViewNavigator::moveToPosition(const QVector3D &position)
{
    double op[3];
...
QWidget* medVTKSimpleViewNavigator::buildToolBoxWidget()
{
...
QWidget* medVTKSimpleViewNavigator::buildToolBarWidget()
{
...
void medVTKSimpleViewNavigator::cameraUp (double *coordinates) const
{
    if (d->orientation != medImageView::VIEW_ORIENTATION_3D)
    {
...
void medVTKSimpleViewNavigator::cameraPosition(double *coordinates) const
{
    if ( d->orientation != medImageView::VIEW_ORIENTATION_3D )
    {
        vtkCamera *camera = d->renderer2d->GetActiveCamera();
...
void medVTKSimpleViewNavigator::cameraFocalPoint(double *coordinates) const
{
    if ( d->orientation != medImageView::VIEW_ORIENTATION_3D )
    {
        vtkCamera *camera = d->renderer2d->GetActiveCamera();
...
void medVTKSimpleViewNavigator::cameraParallelScale(double &parallelScale) const
{
    if ( d->orientation != medImageView::VIEW_ORIENTATION_3D )
        parallelScale =  -1;
    else
...
void medVTKSimpleViewNavigator::setCamera(QHash<QString,QVariant> cameraOptions)
{
...
void medVTKSimpleViewNavigator::setCameraUp(const QVector3D& viewup)
{
    double vup[3];
...
void medVTKSimpleViewNavigator::setCameraPosition(const QVector3D& position)
{
    d->view3d->GetInteractorStyle()->HandleObserversOff();
    vtkCamera *camera = d->renderer3d->GetActiveCamera();
...
void medVTKSimpleViewNavigator::setCameraFocalPoint(const QVector3D& focal)
{
    double foc[3];
...
void medVTKSimpleViewNavigator::setCameraParallelScale(double parallelScale)
{
    d->view3d->GetInteractorStyle()->HandleObserversOff();
...
void medVTKSimpleViewNavigator::setAxial(bool axial)
{
    if(axial)
        this->changeOrientation(medImageView::VIEW_ORIENTATION_AXIAL);
}

void medVTKSimpleViewNavigator::setCoronal(bool coronal)
{
    if(coronal)
        this->changeOrientation(medImageView::VIEW_ORIENTATION_CORONAL);
}

void medVTKSimpleViewNavigator::setSagittal(bool sagittal)
{
    if(sagittal)
        this->changeOrientation(medImageView::VIEW_ORIENTATION_SAGITTAL);
}

void medVTKSimpleViewNavigator::set3d(bool o3d)
{
    if(o3d)
...
void medVTKSimpleViewNavigator::showAxes(bool show)
{
...
void medVTKSimpleViewNavigator::showRuler(bool show)
{
    d->view2d->SetShowRulerWidget(show);
    d->view2d->Render();
}

void medVTKSimpleViewNavigator::showAnnotations(bool show)
{
...
void medVTKSimpleViewNavigator::showScalarBar(bool show)
{
...
void medVTKSimpleViewNavigator::changeOrientation(medImageView::Orientation orientation)
{
...
void medVTKSimpleViewNavigator::updateWidgets()
{
    if(d->orientation == medImageView::VIEW_ORIENTATION_3D)
    {
...
void medVTKSimpleViewNavigator::enableZooming(bool enable)
{
    if(enable)
